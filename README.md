...
Prefer a badge generated by [shields.io](https://shields.io)? This one matches the
color and version, without the branch mark:

```markdown
[![Conventional Branch](https://img.shields.io/badge/Conventional%20Branch-1.1.0-3B6BB5)](https://conventionalbranch.org/)
```

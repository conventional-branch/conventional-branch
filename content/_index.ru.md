...
Долгоживущие интеграционные или средовые ветки (например, `develop`, `staging`, `production`) рассматриваются как основные ветки и не требуют префикса. Их следует именовать последовательно во всём проекте.
